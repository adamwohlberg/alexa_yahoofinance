...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Inject pushes a new value into an array while also holding two variable values in memory, one representing the element of the array on each iteration and the other representing the result of an operation on the values of the array.  
  end
